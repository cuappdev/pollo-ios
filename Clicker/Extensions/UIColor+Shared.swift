...
extension UIColor {
    ...
    @nonobjc static let clickerLightGrey = UIColor(red: 229/255, green: 231/255, blue: 237/255, alpha: 1.0)
    @nonobjc static let clickerMediumGrey = UIColor(red: 158/255, green: 167/255, blue: 179/255, alpha: 1.0)
    ...
    @nonobjc static let clicker85Black = UIColor(red: 32/255, green: 32/255, blue: 32/255, alpha: 0.70)
    @nonobjc static let clicker60Black = UIColor(red: 32/255, green: 32/255, blue: 32/255, alpha: 0.60)
    ...
    @nonobjc static let clickerGradientGrey = UIColor(red: 67/255, green: 67/255, blue: 67/255, alpha: 0.0)
    ...
    @nonobjc static let clickerLabelGrey = UIColor(red: 61/255, green: 61/255, blue: 61/255, alpha: 1.0)
