...
extension UIColor {
    ...
    @nonobjc static let mediumGrey2 = UIColor(white: 193.0 / 255.0, alpha: 1.0)
    ...
    @nonobjc static let clickerGrey12 = UIColor(red: 68/255, green: 68/255, blue: 68/255, alpha: 1.0)
